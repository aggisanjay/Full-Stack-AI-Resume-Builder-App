    ...
    const templates=[
        {
            id:'classic',
            name:'Classic',
            preview:'A clean, traditional layout with clear sections and headings'
        ...
        },
        {
            id:'minimal',
            name:'Minimal',
            preview:'Simple and elegant layout focusing on content with minimal distractions'
        },
        {
            id:'minimal-image',
            name:'Minimal with Image',
            preview:'Clean layout with a prominent profile image and essential information'
        }
